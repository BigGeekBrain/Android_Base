...
//                windDirection.setText();
    ...
    protected void onStart() {
        super.onStart();
        currentInfo("onStart()", "onStart");
    }

    @Override
    protected void onRestoreInstanceState(Bundle saveInstanceState){
        super.onRestoreInstanceState(saveInstanceState);
        currentInfo("Повторный запуск!! - onRestoreInstanceState()", "onRestoreInstanceState");
//        cityTextView.setText(saveInstanceState.getString("City"));
    ...
    protected void onResume() {
        super.onResume();
        currentInfo("onResume()", "onResume");
    }

    @Override
    protected void onPause() {
        super.onPause();
        currentInfo("onPause()", "onPause");
    }

    @Override
    protected void onSaveInstanceState(Bundle saveInstanceState){
        super.onSaveInstanceState(saveInstanceState);
        currentInfo("onSaveInstanceState()", "onSaveInstanceState");
//        saveInstanceState.putString("City", cityTextView.toString());
    ...
    protected void onStop() {
        super.onStop();
        currentInfo("onStop()","onStop");
    }

    @Override
    protected void onRestart() {
        super.onRestart();
        currentInfo("onRestart()", "onRestart");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        currentInfo("onDestroy()", "onDestroy");
    }

    protected void currentInfo(String toastText, String loggerText){
